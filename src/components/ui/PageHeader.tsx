...
export function PageHeader({ title, subtitle, left, right }: Props) {
  return (
    <header className="flex items-center gap-3 px-4 pt-safe-top pb-3 bg-zinc-900/95 backdrop-blur-sm border-b border-zinc-800/80 sticky top-0 z-10 shadow-sm">
